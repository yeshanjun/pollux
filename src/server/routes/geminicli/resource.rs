...
pub struct GeminiCliResourceSeed {
...
pub async fn geminicli_resource_add(
    State(state): State<PolluxState>,
    payload: Result<Json<Vec<GeminiCliResourceSeed>>, JsonRejection>,
